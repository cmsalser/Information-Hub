...
//		attendees.add(attendee);
//
//		Event event1 = new Event(creators, attendees, new Date(2021,4,8), "Covid 19 Vaccination", "www.covid19.world.org/vaccination/join");
//
//		event1 = eventRepository.save(event1);
//
//		Event event2 = new Event(creators, attendees, new Date(2021,4,15), "Covid 19 Awareness Event", "www.covid19.world.org/awareness/join");
//
...
//		attendees.add(attendee);
//
//		Event event = new Event(creators, attendees, new Date(2021,4,8, 12, 5), "Covid 19 Vaccination", "www.covid19.world.org/vaccination/join");
//
//		event = eventRepository.save(event);
//
